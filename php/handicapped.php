				...
				<table class="table table-hover">
					...
					<tbody>
						...
						if (isset($_REQUEST['search']) == null) {
							...
							$sql = "SELECT * FROM habitantes WHERE cedula=:buscar || nombres=:buscar || apellidos=:buscar and discapacidad != '' and discapacidad != 'No' and discapacidad != 'No posee';";
